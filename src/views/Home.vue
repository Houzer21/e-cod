<template>
  <div>
    ...
    <section class="section">
      <h2 class="section__heading">top teams</h2>
      <div class="row m-0 justify-content-center justify-content-md-between">
        ...
        <div class="col-6 col-md-2 p-2">
          <router-link to="/teams" class="card card--link">
            All teams <i class="lni lni-arrow-right-circle"></i>
          </router-link>
        </div>
      </div>
    </section>
    <!-- matchups --->
    <section class="section">
      <h2 class="section__heading">match ups</h2>
      <div class="row m-0 justify-content-center justify-content-md-between">
